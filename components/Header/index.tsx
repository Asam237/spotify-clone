    ...
    return (
        <>
            <header className="sticky top-0 left-0 z-10">
                <div className="h-20 lg:h-24 bg-black flex flex-col justify-center">
                    <div className="flex justify-between lg:justify-start items-center">
                        <div className="text-white flex items-center lg:w-80 px-6 py-8">
                        ...
                        <div className="hidden lg:flex justify-between items-center w-full bg-[#101010] px-6 py-8">
